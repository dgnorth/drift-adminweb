...
def match_players(match_id):
    with sqlalchemy_tenant_session(deployable_name='drift-base') as session:
        ...
        return render_template('matches/match_players.html', match=match, players=players)
...
def match_teams(match_id):
    with sqlalchemy_tenant_session(deployable_name='drift-base') as session:
        ...
        return render_template('matches/match_teams.html', match=match, teams=teams)
...
def match_events(match_id):
    with sqlalchemy_tenant_session(deployable_name='drift-base') as session:
        ...
        return render_template('matches/match_events.html', match=match, events=events)
...
def match_queueplayers(match_id):
    with sqlalchemy_tenant_session(deployable_name='drift-base') as session:
        ...
        return render_template('matches/match_queueplayers.html', match=match, players=players)
