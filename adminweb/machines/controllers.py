...
from driftbase.db.models import Machine, MachineEvent, Server
...
def machine(machine_id):
    ...
    return render_template('machines/machine.html', machine=machine)
...
def machine_events(machine_id):
    with sqlalchemy_tenant_session(deployable_name='drift-base') as session:
        ...
        return render_template('machines/machine_events.html', machine=machine, events=events)
...
def machine_servers(machine_id):
    with sqlalchemy_tenant_session(deployable_name='drift-base') as session:
        ...
        return render_template('machines/machine_servers.html', machine=machine, servers=servers)
